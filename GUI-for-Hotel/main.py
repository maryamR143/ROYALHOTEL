...
#===================Python Variables=======================
menu_category = ["Rooms","Beverages","Fast Food","Continental","Amenities","Tea & Coffee","Dessert"]

menu_category_dict = {"Rooms":"1 Rooms.txt","Beverages":"2 Beverages.txt",
                "Fast Food":"3 Fast Food.txt","Continental":"4 Continental.txt",
                "Amenities":"5 Amenities.txt","Tea & Coffee":"6 Tea & Coffee.txt",
...
def load_menu():
    ...
    for file in menu_file_list:
        ...
        #menu_tabel.insert('',END,values=["food","50"])
...
root.title("Welcome to Royal Hotel")
...
title_label = Label(title_frame, text="ROYAL HOTEL", 
                    font=("times new roman", 20, "bold"),bg = "sky blue", fg="coral4", pady=5)
title_label.pack()

#==============Customer=============
customer_frame = LabelFrame(root,text="Customer Details",font=("times new roman", 15, "bold"),
                            bd=8, bg="coral3", relief=GROOVE)
customer_frame.pack(side=TOP, fill="x")

customer_name_label = Label(customer_frame, text="Name", 
                    font=("arial", 15, "bold"),bg = "coral3", fg="PaleGreen3")
...
#===============Menu===============
menu_frame = Frame(root,bd=8, bg="coral3", relief=GROOVE)
menu_frame.place(x=0,y=125,height=585,width=680)

menu_label = Label(menu_frame, text="Catalogue", 
                    font=("times new roman", 20, "bold"),bg = "coral3", fg="black", pady=0)
menu_label.pack(side=TOP,fill="x")

menu_category_frame = Frame(menu_frame,bg="coral3",pady=10)
menu_category_frame.pack(fill="x")

combo_lable = Label(menu_category_frame,text="Select Type", 
                    font=("arial", 12, "bold"),bg = "coral3", fg="PaleGreen3")
...
#===============Item Frame=============
item_frame = Frame(root,bd=8, bg="coral3", relief=GROOVE)
item_frame.place(x=680,y=125,height=230,width=680)

item_title_label = Label(item_frame, text="Item", 
                    font=("times new roman", 20, "bold"),bg = "coral3", fg="black")
item_title_label.pack(side=TOP,fill="x")

item_frame2 = Frame(item_frame, bg="coral3")
...
item_frame3 = Frame(item_frame, bg="coral3")
...
#==============Order Frame=====================
order_frame = Frame(root,bd=8, bg="coral3", relief=GROOVE)
order_frame.place(x=680,y=335,height=370,width=680)

order_title_label = Label(order_frame, text="Your Reservations", 
                    font=("times new roman", 20, "bold"),bg = "coral3", fg="black")
